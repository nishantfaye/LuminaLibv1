...
from app.domain.services import IReviewService
...
class ReviewService(IReviewService):
    ...
    def __init__(
        ...
        book_analysis_repository: IBookAnalysisRepository,
        llm_service: ILLMService,
    ):
        self.review_repository = review_repository
        self.borrow_repository = borrow_repository
        self.book_repository = book_repository
        self.book_analysis_repository = book_analysis_repository
    ...
    async def get_book_analysis(self, book_id: UUID) -> dict:
        ...
        cached = await self.book_analysis_repository.get_by_book_id(book_id)
